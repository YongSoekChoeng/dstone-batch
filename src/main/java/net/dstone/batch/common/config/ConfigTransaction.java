...
public class ConfigTransaction extends BatchBaseObject{
	...
	********************************************************************************/
	...
	public TransactionInterceptor txAdviceCommon(@Qualifier("txManagerCommon") PlatformTransactionManager txManagerCommon) {
	...
	public Advisor txAdvisorCommon(@Qualifier("txManagerCommon") PlatformTransactionManager txManagerCommon) {
